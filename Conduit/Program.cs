...
builder.Services.AddScoped<AddTagsHandler>();
builder.Services.AddScoped<FeedArticlesHandler>();
builder.Services.AddScoped<DeleteTagsFromArticleHandler>();
builder.Services.AddScoped<TagsCreationHandler>(); 
builder.Services.AddScoped<CommentCreationHandler>(); 
builder.Services.AddScoped<AddCommentHandler>(); 
builder.Services.AddScoped<GetCommentsFromArticleHandler>();
